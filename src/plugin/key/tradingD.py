...
import random
from . import config_trading
tk = config_trading.TK_info()
app = FastAPI()
Url,StreamURL,TwoFAType,NotifyId,ConsumerID,ConsumerSecret,PrivateKey = tk.TK_D()

client = FCTradingClient(Url, ConsumerID,
	ConsumerSecret, PrivateKey, TwoFAType)
...
async def fc_get_otp():
	...
	"""
	fc_req = fcmodel_requests.GetOTP(ConsumerID, ConsumerSecret)
